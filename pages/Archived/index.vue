        ...
        <div class="flex flex-col items-center gap-6">
          <figure style="width: 336px;">
            <span
              ...
              <img alt="{{ $t('archivedEmptyTitle') }}" src="~/assets/images/emptyPages/Bookmarks.png" decoding="async"
                data-nimg="responsive" class="object-cover" sizes="100vw"
                style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
            </span>
          </figure>
          <div class="flex flex-col gap-2 text-center">
            <p class="text-3xl font-extrabold">{{ $t('archivedEmptyTitle') }}</p>
            <p class="text-light-secondary dark:text-dark-secondary">{{ $t('archivedEmptyDescription') }}</p>
          </div>
        </div>
      </div>
    </div>
