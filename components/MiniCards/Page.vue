		...
		>
			...
			<div class="flex items-center justify-between mt-4">
				...
				<svg
					...
					fill="none"
					class="w-6 stroke-slate-500 transition-all group-hover:translate-x-1 group-hover:stroke-slate-400"
					stroke-linecap="round"
					stroke-linejoin="round"
					stroke-width="2"
					viewBox="0 0 24 24"><path d="M4 12h16M14 6l6 6-6 6" /></svg
				>
			</div>
		</div>
	</div>
